...
export default function Datalist(props) {
  ...
  const GET_QUOTATION_DETAIL =
    API_URL_WS_SALES_PLAN + "GET_QUOTATION_DETAIL_V2";
      ...
      <>
        <div className="app-details-item">
          <div className="app-details-item-header">
            <h4>
              {product.title} {YEAR} ( {P_USER} - {P_YEAR} )
            </h4>
          </div>
          <div className="app-details-item-details">
            ...
            <div>Quotations Created :  <label className="txtvalue">{Quotations_Created}</label></div>
            <div>Quotaion to Sale :  <label className="txtvalue">{Quotaion_to_Sale}</label></div>
